      ...
      {!isWorkPage && (
        <div className="absolute left-[65%] bottom-8 pointer-events-auto hidden md:flex gap-3 leading-tight">
          ...
          <div className="flex flex-col">
            <Link href="/" className="font-bold text-[#f1e5d1] mb-1 hover:text-[#f1e5d1]/80 transition-colors">ALL <span className="italic font-serif normal-case opacity-70">(10)</span></Link>
